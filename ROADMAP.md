...
- [ ] **A38 PlaytestBot-Nichtdeterminismus** (Nebenbefund A34, 2026-09-13) — derselbe `rng_seed` (1001) lieferte solo vs. im Concurrency-Batch unterschiedliche Ergebnisse (`nexus_debt`, Action-Zahlen). DB-Isolation ist sauber (jeder Prozess eigene `:memory:`-DB, siehe Kommentar in `app/Console/Commands/Playtest.php`) — Ursache liegt woanders, noch nicht untersucht. Wichtig für die Verlässlichkeit aller Playtest-Batches, nicht nur A34. — Mittel
