...
return [
    ...
    'popup_sup_desc' => 'Power, water, infrastructure — abstracted into a single figure. Buildings and ships draw from the capacity; once the limit is exhausted, no further unit can be brought online. The display shows the remaining free capacity.',
    ...
    'popup_nav_ap_title' => 'Navigation AP',
    'popup_nav_ap_desc' => 'Every sector explored is a little more room to manoeuvre. Navigation AP drives exploration and missions — and only comes through the Pilot advisor.',

    'popup_bau_ap_title' => 'Construction AP',
    'popup_bau_ap_desc' => 'A Sol without Construction AP is a Sol where decay wins. The Engineer raises the allowance — without them, the pool stays thin.',

    'popup_research_ap_title' => 'Research AP',
    'popup_research_ap_desc' => 'Knowledge doesn\'t grow on its own. Research AP is assigned to a knowledge field in the tech tree and pays out Sol by Sol.',

    'popup_economy_ap_title' => 'Economy AP',
    'popup_economy_ap_desc' => 'Cantina deals, Nexus negotiations, trade routes — all of that costs Economy AP. Without a Consul the pool stays lean.',

    'popup_strategy_ap_title' => 'Strategy AP',
    'popup_strategy_ap_desc' => 'For everything that protection and tactical coordination costs. The Strategist builds the pool — without them the budget stays tight.',
