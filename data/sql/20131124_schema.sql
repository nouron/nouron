...
CREATE TABLE IF NOT EXISTS `fleet_personell` (
  ...
  UNIQUE KEY `nFlee2` (`fleet_id`,`personell_id`,`is_cargo`),
  KEY `personell_id` (`personell_id`),
  KEY `fleet_id` (`fleet_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `fleet_researches` (
  ...
  `count` int(10) unsigned NOT NULL,
  `is_cargo` tinyint(1) unsigned NOT NULL DEFAULT '0',
  UNIQUE KEY `nFlee2` (`fleet_id`,`research_id`,`is_cargo`),
  KEY `research_id` (`research_id`),
  KEY `fleet_id` (`fleet_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `fleet_ships` (
  ...
  `count` int(10) unsigned NOT NULL,
  `is_cargo` tinyint(1) unsigned NOT NULL DEFAULT '0',
  UNIQUE KEY `nFlee2` (`fleet_id`,`ship_id`,`is_cargo`),
  KEY `ship_id` (`ship_id`),
  KEY `fleet_id` (`fleet_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `ships` (
  ...
  UNIQUE KEY `row` (`row`,`column`),
  KEY `required_building_id` (`required_building_id`),
  KEY `required_research_id` (`required_research_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
ALTER TABLE `fleets`
  ADD CONSTRAINT `fleets_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `fleet_orders`
  ADD CONSTRAINT `fleet_orders_ibfk_1` FOREIGN KEY (`fleet_id`) REFERENCES `fleets` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `fleet_personell`
  ADD CONSTRAINT `fleet_personell_ibfk_1` FOREIGN KEY (`fleet_id`) REFERENCES `fleets` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fleet_personell_ibfk_2` FOREIGN KEY (`personell_id`) REFERENCES `personell` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `fleet_researches`
  ADD CONSTRAINT `fleet_researches_ibfk_1` FOREIGN KEY (`fleet_id`) REFERENCES `fleets` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fleet_researches_ibfk_2` FOREIGN KEY (`research_id`) REFERENCES `researches` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `fleet_resources`
  ADD CONSTRAINT `fleet_resources_ibfk_1` FOREIGN KEY (`fleet_id`) REFERENCES `fleets` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fleet_resources_ibfk_2` FOREIGN KEY (`resource_id`) REFERENCES `resources` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `fleet_ships`
  ADD CONSTRAINT `fleet_ships_ibfk_1` FOREIGN KEY (`fleet_id`) REFERENCES `fleets` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fleet_ships_ibfk_2` FOREIGN KEY (`ship_id`) REFERENCES `ships` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `personell`
  ADD CONSTRAINT `personell_ibfk_1` FOREIGN KEY (`required_building_id`) REFERENCES `buildings` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `ships`
  ADD CONSTRAINT `ships_ibfk_1` FOREIGN KEY (`required_building_id`) REFERENCES `buildings` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `ships_ibfk_2` FOREIGN KEY (`required_research_id`) REFERENCES `researches` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
