...
INSERT INTO "buildings" (id,purpose,name,required_building_id,required_building_level,prime_colony_only,"row","column",max_level,max_instances,ap_for_levelup,max_status_points,decay_rate,supply_cost,is_instanced,is_active) VALUES(46,'civil','building_infirmary',25,3,0,3,2,NULL,NULL,10,20,0.80,10,0,1);
...
INSERT INTO "buildings" (id,purpose,name,required_building_id,required_building_level,prime_colony_only,"row","column",max_level,max_instances,ap_for_levelup,max_status_points,decay_rate,supply_cost,is_instanced,is_active) VALUES(52,'civil','building_bar',25,2,0,2,3,NULL,NULL,10,20,0.80,6,0,1);
