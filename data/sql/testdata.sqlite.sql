...
INSERT INTO "buildings" (id,purpose,name,required_building_id,required_building_level,prime_colony_only,"row","column",max_level,max_instances,ap_for_levelup,max_status_points,decay_rate,supply_cost,is_instanced,is_active) VALUES(28,'civil','building_housingComplex',25,1,1,1,1,6,6,10,20,0.44,0,1,1);
INSERT INTO "buildings" (id,purpose,name,required_building_id,required_building_level,prime_colony_only,"row","column",max_level,max_instances,ap_for_levelup,max_status_points,decay_rate,supply_cost,is_instanced,is_active) VALUES(31,'civil','building_sciencelab',25,2,0,2,2,NULL,NULL,10,20,0.95,8,0,1);
...
INSERT INTO "buildings" (id,purpose,name,required_building_id,required_building_level,prime_colony_only,"row","column",max_level,max_instances,ap_for_levelup,max_status_points,decay_rate,supply_cost,is_instanced,is_active) VALUES(41,'industry','building_bioFacility',27,1,0,2,1,NULL,NULL,10,20,0.95,2,0,1);
INSERT INTO "buildings" (id,purpose,name,required_building_id,required_building_level,prime_colony_only,"row","column",max_level,max_instances,ap_for_levelup,max_status_points,decay_rate,supply_cost,is_instanced,is_active) VALUES(44,'civil','building_hangar',25,2,0,3,3,NULL,NULL,10,20,0.67,6,1,1);
INSERT INTO "buildings" (id,purpose,name,required_building_id,required_building_level,prime_colony_only,"row","column",max_level,max_instances,ap_for_levelup,max_status_points,decay_rate,supply_cost,is_instanced,is_active) VALUES(46,'civil','building_infirmary',25,3,0,3,2,NULL,NULL,10,20,2.0,10,0,1);
...
INSERT INTO "buildings" (id,purpose,name,required_building_id,required_building_level,prime_colony_only,"row","column",max_level,max_instances,ap_for_levelup,max_status_points,decay_rate,supply_cost,is_instanced,is_active) VALUES(52,'civil','building_bar',25,2,0,2,3,NULL,NULL,10,20,1.0,4,0,1);
