...
INSERT INTO `fleets` (`id`, `fleet`, `user_id`, `artefact`, `x`, `y`, `spot`) VALUES
...
INSERT INTO `fleet_orders` (`tick`, `fleet_id`, `order`, `coordinates`, `data`, `was_processed`, `has_notified`) VALUES
...
INSERT INTO `fleet_personell` (`fleet_id`, `personell_id`, `count`, `is_cargo`) VALUES
(10, 35, 4, 0),
(10, 36, 2, 0),
(10, 89, 1, 0),
(11, 92, 1, 0),
...
INSERT INTO `fleet_researches` (`fleet_id`, `research_id`, `count`, `is_cargo`) VALUES
(10, 33, 10, 0),
(10, 34, 11, 0),
(10, 39, 1, 0),
(10, 72, 2, 0),
...
INSERT INTO `fleet_resources` (`fleet_id`, `resource_id`, `amount`) VALUES
(8, 3, 0),
(8, 5, 0),
(8, 6, 0),
(8, 8, 790),
...
INSERT INTO `fleet_ships` (`fleet_id`, `ship_id`, `count`, `is_cargo`) VALUES
(8, 29, 20, 0),
(8, 37, 5, 0),
(10, 29, 19, 0),
(10, 37, 7, 0),
