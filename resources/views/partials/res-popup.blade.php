{{--
    ...
    Variables:
      ...
      $popup_interactive — optional bool: the extra contains an action (button), so
                      the popup must accept pointer events (see .res-popup--interactive)
--}}
<div class="res-popup{{ !empty($popup_interactive ?? false) ? " res-popup--interactive" : "" }}"
    x-show="openChip === {{ Illuminate\Support\Js::from($popup_key) }}" x-cloak
