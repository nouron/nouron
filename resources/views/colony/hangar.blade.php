            ...
            <div class="carousel-track" :style="trackStyle()">
                ...
                <template x-for="(slot, i) in slots" :key="slot.instance_id">
                    <div class="hangar-card"
                         :class="{ 'hangar-card--current': i === activeIndex }">
                        ...
                        <div class="hangar-icon-area">
                            ...
                            <template x-if="slot.ship !== null">
                                <svg class="hangar-icon-placeholder"
                        ...
                        <div class="hangar-info">
                            ...
                            <div class="hangar-name-row">
                                <span class="hangar-name"
                                      x-text="slot.ship ? shipLabel(slot.ship.name) : '—'">
                                </span>
                                <template x-if="slot.ship !== null">
                                    <span class="hangar-stat-value"
                                          x-text="'Lv ' + slot.ship.level">
                                    </span>
                                </template>
                            </div>
                            ...
                            <template x-if="slot.ship !== null && slot.ship.ship_state === 'docked'">
                                <div style="display:contents">
                                    ...
                                    <div class="hangar-stat-row">
                                        <span class="hangar-stat-label">{{ __('colony.hangar_status') }}</span>
                                        <span class="hangar-stat-value"
                                              x-text="slot.ship.status_points + '/20'">
                                        </span>
                                    </div>
                                    ...
                                    <template x-if="modalType[slot.instance_id] === 'dispatch'">
                                        <div class="hangar-form">
                                            <label>
                                                ...
                                                <input type="text"
                                                       x-model="dispatchDest[slot.instance_id]"
                                            ...
                                            <div class="hangar-form-actions">
                                                ...
                                                <button class="btn-hangar-action"
                                                    ...
                                                    <span x-text="loading[slot.instance_id] ? '…' : i18n.dispatch"></span>
                                                </button>
                                            </div>
                                        </div>
                                    </template>
                                    ...
                                    {{-- Repair form --}}
                                    <template x-if="modalType[slot.instance_id] === 'repair'">
                                        <div class="hangar-form">
                                            <label>
                                                <div class="form-row-label">
                                                    <span>AP</span>
                                                    <strong x-text="repairAp[slot.instance_id]"></strong>
                                                </div>
                                                <input type="range" min="1" max="10"
                                                       x-model="repairAp[slot.instance_id]">
                                            </label>
                                            <div class="hangar-error" x-text="error[slot.instance_id]"></div>
                                            <div class="hangar-form-actions">
                                                <button class="btn-hangar-action btn-hangar-action--secondary"
                                                ...
                                                <button class="btn-hangar-action"
                                                        ...
                                                        :disabled="loading[slot.instance_id]">
                                                    <span x-text="loading[slot.instance_id] ? '…' : i18n.repair"></span>
                                                </button>
                                            </div>
                                        </div>
                                    </template>
                                    ...
                                    <template x-if="modalType[slot.instance_id] === null">
                                        <div class="hangar-card-footer">
                                            ...
                                            <button class="btn-hangar-action btn-hangar-action--secondary"
                                                    @click="openModal(slot.instance_id, 'repair')"
                                                    :disabled="slot.ship.status_points >= 20">
                                    ...
                                    <template x-if="modalType[slot.instance_id] === null && error[slot.instance_id]">
                                        <div class="hangar-error" x-text="error[slot.instance_id]"></div>
                                    </template>
                            ...
                            <template x-if="slot.ship !== null && slot.ship.ship_state === 'dispatched'">
                                <div style="display:contents">
                                    ...
                                    <div class="hangar-mission-info"
                                         x-show="slot.ship.active_mission !== null">
