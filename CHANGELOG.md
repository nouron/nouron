...
- Test: A37-Teilbefund — `RunReport` trackt jetzt Kenntnis-Level pro Sol (vorher gar nicht erfasst). Ein voller Bot-Lauf zeigte: nur 1 von 7 Kenntnissen je angefasst, `task_research_lead` (3 Kenntnisse auf Lv5) strukturell unerreichbar. Unklar ob Bot-Strategie-Artefakt oder echte AP-Ökonomie-Lücke — game-designer-Einschätzung angefragt, siehe ROADMAP A37.
