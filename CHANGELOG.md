...
- UI: A32 — Playtest-Dashboard um 3 MVP-Detail-Charts erweitert (F8, nach A31). `tools/playtest-dashboard.php` zeigt jetzt AP-Bilanz, Regolith-Quellen und Supply-Auslastung (mit 70%-Zielmarke) als Stacked-Area-Charts für den im Log-Panel gewählten Einzel-Lauf. Echte Browser-Verifikation via Playwright. Verbleibende 4 Charts aus dem Plan bleiben iterativ.
