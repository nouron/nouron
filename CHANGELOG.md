...
- **Fog visuell klar gemacht** (ui-specialist) — Fog-Tiles waren nahezu weiß/unsichtbar; jetzt gedämpftes Slate/Blaugrau mit Nebel-Schraffur, zwei unterscheidbare Arten: **Zonen-Fog** (baubar, noch unentdeckt — gestrichelter Rand + „+"-Glyph) und **Explorations-Fog** (Scout-Ziel — „?"-Glyph). Der verwirrende „CC ↑"-Badge (erkundete Tiles außerhalb der Zone) ist durch ein Schloss-Symbol ersetzt („bald bebaubar — mit CC-Ausbau"). Neue eingeklappte Hex-Grid-Legende erklärt die Zustände.
