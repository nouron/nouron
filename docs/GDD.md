...
| **Organika** | Agrardom | `agronomy`, +Σ7 Or/Sol bei Lv5, glockenförmig (implementiert 2026-08-15, siehe §13.5-Nachtrag) | `mission_supply_run`, 10 je Umlauf | Ankauf über Bar-Angebote |
...
>
> **Nachtrag (2026-08-14):** Corvans Alltagsgeschäft (`MerchantService::shouldSpawn()`) ist ebenfalls hart an eine gebaute Cantina (Bar Lv1+) gekoppelt — ohne Cantina entfällt also nicht nur der Handelsvertrag, sondern auch dieser zweite Einnahmekanal vollständig. Da Sciencelab/Hangar/Cantina gleichrangige Pfadwahl-Optionen sind (§13 „Slot-System"), ist der komplette Wegfall beider Kanäle kein Rand-, sondern der Normalfall für jeden Lauf, der die Cantina nicht (zuerst) baut — das unterschätzte der 07-19-Break-even, der nur den Konsul-Fall bei Rang 2 durchrechnete. Volle Herleitung + Fix: §18.4 (Nachtrag 2026-08-14).
