...
10. **Bauten außerhalb der Koloniezone (offene Idee, Lore-/Gameplay-Fit ungeprüft).** Owner-Idee (2026-08-25): kleine Konstruktionen (z.B. Sendemast) außerhalb der bisherigen Koloniezone/Hexfelder platzierbar. Explizit konditional vom Owner: nur weiterverfolgen, wenn es zur Lore und zum Gameplay passt, sonst fallen lassen. Noch nicht bewertet — game-designer-Review aussteht.
