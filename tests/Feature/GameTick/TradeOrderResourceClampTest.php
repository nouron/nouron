 ...
 *     fleet_resources: res_compounds(4)=420, res_organics(5)=10
 *   Colony 1 (Springfield, user_id=3) at (6828, 3016):
 *     colony_resources: res_compounds(4)=18598, res_organics(5)=6335
 *
...
class TradeOrderResourceClampTest extends TestCase
{
    ...
    {
        $this->setFleetResource($this->fleetId, $this->resWerkstoffe, 100);
        $colonyBefore = $this->getColonyResource($this->colonyId, $this->resWerkstoffe);

        $this->insertTradeOrder(7001, $this->fleetId, $this->colonyId, $this->resWerkstoffe, 500, 1);
        ...
        $this->assertGreaterThanOrEqual(
            $colonyBefore + 100,
            $this->getColonyResource($this->colonyId, $this->resWerkstoffe),
    ...
    {
        $this->setColonyResource($this->colonyId, $this->resWerkstoffe, 50);
        $fleetBefore = $this->getFleetResource($this->fleetId, $this->resWerkstoffe);

        $this->insertTradeOrder(7004, $this->fleetId, $this->colonyId, $this->resWerkstoffe, 300, 0);

        Artisan::call('game:tick', ['--tick' => 7004]);

        $fleetAfter = $this->getFleetResource($this->fleetId, $this->resWerkstoffe);
    ...
    {
        $this->setColonyResource($this->colonyId, $this->resWerkstoffe, 75);
        $fleetBefore = $this->getFleetResource($this->fleetId, $this->resWerkstoffe);

        $this->insertTradeOrder(7006, $this->fleetId, $this->colonyId, $this->resWerkstoffe, 75, 0);
    ...
    {
        $fleetStock = 100;
        $this->setFleetResource($this->fleetId, $this->resWerkstoffe, $fleetStock);

        $this->insertTradeOrder(7007, $this->fleetId, $this->colonyId, $this->resWerkstoffe, 9999, 1);
        ...
        $this->assertLessThanOrEqual($fleetStock,
            $this->getFleetResource($this->fleetId, $this->resWerkstoffe),
    ...
    public function test_buy_does_not_create_resources_from_nothing(): void
    {
        $colonyStock = 50;
        $fleetBefore = $this->getFleetResource($this->fleetId, $this->resWerkstoffe);
        $this->setColonyResource($this->colonyId, $this->resWerkstoffe, $colonyStock);

        $this->insertTradeOrder(7008, $this->fleetId, $this->colonyId, $this->resWerkstoffe, 9999, 0);
